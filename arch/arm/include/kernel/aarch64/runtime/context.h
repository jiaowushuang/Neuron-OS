...
#define CTX_ELR_ELX		U(0x100)
#define CTX_SPSR_ELX		U(0x108)
...
#define CTX_EL3STATE_END	U(0x30) /* Align to the next 16 byte boundary */

#endif /* CTX_INCLUDE_EL3_REGS */
...
#elif CTX_INCLUDE_EL3_REGS
#define CTX_EL2_SYSREGS_OFFSET	(CTX_EL3STATE_OFFSET + CTX_EL3STATE_END)
#else
...
#define CTX_FPREGS_OFFSET	(CTX_GPREGS_OFFSET + CTX_GPREGS_END + 0x18)
...
#if CTX_INCLUDE_FPREGS
#define LOGICAL_CPU_PC_OFFSET ((CTX_GPREG_ALL+CTX_FPREG_ALL) << DWORD_SHIFT)
#else
#define LOGICAL_CPU_PC_OFFSET ((CTX_GPREG_ALL) << DWORD_SHIFT)
#endif

typedef struct logical_cpu_context {
	gp_regs_t gpregs_ctx;
#if CTX_INCLUDE_FPREGS
	fp_regs_t fpregs_ctx;
#endif	
} logical_cpu_context_t;

/* Macros to access members of the 'pcpu_context_t' structure */
#define get_gpregs_ctx(h)	(&((logical_cpu_context_t *) h)->gpregs_ctx)
...
#endif
#if CTX_INCLUDE_FPREGS
# define get_fpregs_ctx(h)	(&((logical_cpu_context_t *) h)->fpregs_ctx)
#endif
 ...
 */
CASSERT(CTX_GPREGS_OFFSET == __builtin_offsetof(logical_cpu_context_t, gpregs_ctx), \
...
#endif
#if CTX_INCLUDE_FPREGS
CASSERT(CTX_FPREGS_OFFSET == __builtin_offsetof(logical_cpu_context_t, fpregs_ctx), \
