...
"""
Linter for the Kconfig files. Pass --help to see
...
def modules_file_dir():
    ...
    run((os.path.join("scripts/kconfig", "kconfig_module.py"),
...
def run(cmd, cwd=TOP_DIR):
    ...
    # the working directory. It defaults to the top-level WellL4 directory.
