...
set(kernel_arch ${CONFIG_KERNEL_ARCH})
set(arch ${CONFIG_ARCH})
set(mode ${CONFIG_KERNEL_BITS})
set(cross_prefix ${CONFIG_CROSS_PREFIX})
...
function(find_prefixed_gcc out_var)
...
endfunction(find_prefixed_gcc)

if("${CROSS_COMPILER_PREFIX}" STREQUAL "")
    if(("${arch}" STREQUAL "arm") OR ("${arch}" STREQUAL "x86") OR ("${arch}" STREQUAL "riscv"))
        if(${kernel_arch} STREQUAL "aarch32" OR ${kernel_arch} STREQUAL "arm_hyp")
            find_prefixed_gcc(CROSS_COMPILER_PREFIX "arm-linux-gnueabi-" "arm-linux-gnu-")
        elseif(${kernel_arch} STREQUAL "aarch64")
